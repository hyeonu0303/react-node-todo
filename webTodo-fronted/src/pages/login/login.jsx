      ...
      <LoginBox>
        ...
        <SocialContent>
          ...
          <SocialButton style={{fontFamily:'Roboto-Medium'}} onClick={()=>{window.location.href='/auth/google'}}>
            <svg width="18px" height="18px" viewBox="-3 0 262 262" version="1.1" preserveAspectRatio="xMidYMid">
              <g>
                ...
                <path d="M56.281,156.37 C53.525,148
                .247 51.93,139.543 51.93,130.55 C51.93,121.556 53.525,112.853 56.136,104.73 L56.063,103 L15.26,71.312 L13.925,71.947 C5.077,89.644 0,109.517 0,130.55 C0,151.583 5.077,171.455 13.925,189.152 L56.281,156.37" fill="#FBBC05"></path>
        ...
        <LoginFooter>
          <span>계정이없으신가요?</span> <strong><Link to='/register'>가입하기</Link></strong>
        </LoginFooter>
      </LoginBox>
    </LoginContainer>
  );
